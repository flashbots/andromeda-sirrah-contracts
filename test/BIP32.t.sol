...
contract BIP32_Test is Test {
    ...
    function testSHA512() public view {
        ...
        bytes memory expected = bytes(
            hex"ee26b0dd4af7e749aa1a8ee3c10ae9923f618980772e473f8819a5d4940e0db27ac185f8a0e1d5f84f88bc887fd67b143732c304cc5fa9ad8e6f57f50028a8ff"
        );
        require(keccak256(result) == keccak256(expected));
    }

    function testSplitFunction() public view {
        (bytes32 left, bytes32 right) = bip32.split(
            bytes(
                hex"70fc1da84876732b9ab9db31d877059091ec094613681db29aaa78fa6b03af93b71a989780bde3370eb595f505d58d0a0059186a336c40b8581da2df2193592c"
            )
        );
    ...
    function testDeriveKey() public view {
        ...
        (BIP32.ExtendedPrivateKey memory pathXPriv,) = bip32.deriveChildKeyPairFromPath(seed, "m");
    ...
    function testDeriveNonHardenedKey() public view {
        ...
        (BIP32.ExtendedPrivateKey memory cxPriv,) = bip32.deriveChildKeyPair(xPriv, 0);
        (BIP32.ExtendedPrivateKey memory pathCXPriv,) = bip32.deriveChildKeyPairFromPath(seed, "m/0");
    ...
    function testDeriveHardenedKey() public view {
        ...
        (BIP32.ExtendedPrivateKey memory hcxPriv,) = bip32.deriveChildKeyPair(xPriv, 2147483648);
        (BIP32.ExtendedPrivateKey memory pathHCXPriv,) = bip32.deriveChildKeyPairFromPath(seed, "m/0'");
    ...
    function testDeriveNonHardenedFromHardenedKey() public view {
        ...
        (BIP32.ExtendedPrivateKey memory nhcxPriv,) = bip32.deriveChildKeyPair(hcxPriv, 0);
        (BIP32.ExtendedPrivateKey memory pathNHCXPriv,) = bip32.deriveChildKeyPairFromPath(seed, "m/0'/0");
    ...
    function testDeriveChildPubKeyFromParentPubKey() public view {
        ...
        (, BIP32.ExtendedPublicKey memory cxPub) = bip32.deriveChildKeyPair(xPriv, 0);
